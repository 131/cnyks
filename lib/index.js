...
const statik     = require('uclass/static');
...
const pread      = promisify(require("read"));
...
//  Binds : ["run", "completer"],
  ...
  */ {
    ...
    if(!command_infos)
      throw new Error(util.format("Invalid command key '%s'", command_prompt));
  ...
  */ {
   ...
   var proto = typeof obj == "function" ? obj.prototype : Object.getPrototypeOf(obj);
    ...
    Object.getOwnPropertyNames(proto).forEach(function(method_name){
      if(typeof obj[method_name] != "function") return;
      if(method_name == "initialize" || method_name == "constructor") return;
  ...
  start : statik( function(module_name, opts){
    ...
    runner.module_name = path.basename(module_name);

    var module_path = module_name;
    ...
    var module = typeof Module == "function" ? new Module() : Module;
    ...
    co(runner.run.bind(runner), opts).catch(function(err){
